...
TEST_CASE("empty plaintext results in an empty ciphertext", "[407c3837-9aa7-4111-ab63-ec54b58e8e9f]") {
    REQUIRE("" == crypto_square::cipher("").normalized_cipher_text());
}

#if defined(EXERCISM_RUN_ALL_TESTS)
TEST_CASE("normalization results in empty plaintext", "[aad04a25-b8bb-4304-888b-581bea8e0040]") {
    REQUIRE("" ==
...
// clang-format off
TEST_CASE("8 character plaintext results in 3 chunks, the last one with a trailing space", "[a65d3fa1-9e09-43f9-bcec-7a672aec3eae]") {
    REQUIRE("clu hlt io " ==
            crypto_square::cipher("Chill out.").normalized_cipher_text());
}

TEST_CASE("54 character plaintext results in 7 chunks, the last two with trailing spaces", "[fbcb0c6d-4c39-4a31-83f6-c473baa6af80]") {
