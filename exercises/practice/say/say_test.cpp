...
TEST_CASE("zero") { REQUIRE("zero" == say::in_english(0ULL)); }

#if defined(EXERCISM_RUN_ALL_TESTS)
TEST_CASE("one") { REQUIRE("one" == say::in_english(1ULL)); }

TEST_CASE("fourteen") { REQUIRE("fourteen" == say::in_english(14ULL)); }

TEST_CASE("twenty") { REQUIRE("twenty" == say::in_english(20ULL)); }

TEST_CASE("twenty_two") { REQUIRE("twenty-two" == say::in_english(22ULL)); }

TEST_CASE("sixty_nine") { REQUIRE("sixty-nine" == say::in_english(69ULL)); }

TEST_CASE("one_hundred") { REQUIRE("one hundred" == say::in_english(100ULL)); }
