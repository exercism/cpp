...
TEST_CASE("Roster is empty when no student is added",
...
TEST_CASE("Student is added to the roster",
...
TEST_CASE("Adding multiple students in the same grade in the roster",
...
TEST_CASE("Multiple students in the same grade are added to the roster",
...
TEST_CASE("Students are sorted by grades and then by name in the roster",
    ...
    REQUIRE(school_.roster() ==
            map<int, vector<string>>{{1, {"Anna", "Barb", "Charlie"}},
                                     {2, {"Alex", "Peter", "Zoe"}},
                                     {3, {"Jim"}}});
}

TEST_CASE("Grade is empty if no students in the roster",
          "[5e67aa3c-a3c6-4407-a183-d8fe59cd1630]") {
    const grade_school::school school_;
    REQUIRE(school_.grade(1).empty());
}

TEST_CASE("Grade is empty if no students in that grade",
...
TEST_CASE("Student not added to same grade more than once",
...
TEST_CASE("Student not added to multiple grades",
...
TEST_CASE("Student not added to other grade for multiple grades",
...
TEST_CASE("Students are sorted by name in a grade",
