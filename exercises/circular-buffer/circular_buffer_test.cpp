...
{
    circular_buffer::circular_buffer<value_type> buffer(1);
...
{
    circular_buffer::circular_buffer<value_type> buffer(2);
...
{
    circular_buffer::circular_buffer<value_type> buffer(3);
