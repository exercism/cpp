...
The first one is a reference to the ingredient list of your own recipe, while the second one is the `vector of strings` of the ingredient list your friend sent you.
