...
Each of these parameters is a `<vector>` (of integers and of strings respectively) such that the *n*th score in `student_scores` belongs to the *n*th student in `student_names`.
