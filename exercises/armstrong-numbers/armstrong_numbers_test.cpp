...
// Armstrong-number exercise test case data version 1.1.0
...
{
    REQUIRE(!armstrong_numbers::is_armstrong_number(10));
}
...
{
    REQUIRE(!armstrong_numbers::is_armstrong_number(100));
}
...
{
    REQUIRE(!armstrong_numbers::is_armstrong_number(9475));
}
...
{
    REQUIRE(!armstrong_numbers::is_armstrong_number(9926314));
}
