...
In example the distance to get from "mine" to "times" would be 3
...
Wikipedia [https://en.wikipedia.org/wiki/Levenshtein_distance](https://en.wikipedia.org/wiki/Levenshtein_distance)
