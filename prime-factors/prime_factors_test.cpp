...
BOOST_AUTO_TEST_CASE(_1_yields_empty)
{
    ...
    const auto actual{prime_factors::of(1)};
...
BOOST_AUTO_TEST_CASE(_2_yields_2)
{
    ...
    const auto actual{prime_factors::of(2)};
...
BOOST_AUTO_TEST_CASE(_3_yields_3)
{
    ...
    const auto actual{prime_factors::of(3)};
...
BOOST_AUTO_TEST_CASE(_4_yields_2_2)
{
    ...
    const auto actual{prime_factors::of(4)};
...
BOOST_AUTO_TEST_CASE(_6_yields_2_3)
{
    ...
    const auto actual{prime_factors::of(6)};
...
BOOST_AUTO_TEST_CASE(_8_yields_2_2_2)
{
    ...
    const auto actual{prime_factors::of(8)};
...
BOOST_AUTO_TEST_CASE(_9_yields_3_3)
{
    ...
    const auto actual{prime_factors::of(9)};
...
BOOST_AUTO_TEST_CASE(_27_yields_3_3_3)
{
    ...
    const auto actual{prime_factors::of(27)};
...
BOOST_AUTO_TEST_CASE(_625_yields_5_5_5_5)
{
    ...
    const auto actual{prime_factors::of(625)};
...
BOOST_AUTO_TEST_CASE(_901255_yields_5_17_23_461)
{
    ...
    const auto actual{prime_factors::of(901255)};
